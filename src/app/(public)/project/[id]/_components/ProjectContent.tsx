    ...
    <>
      ...
      <section>
        ...
        <div className="space-y-6">
          <p className="p-6 text-slate-300 text-lg">{project.solution}</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-6 rounded-2xl bg-[#182234] border border-[#222f49] hover:border-primary/50 transition-colors shadow-sm">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">Implemented windowing and lazy loading patterns for large datasets, ensuring the interface remains fluid under heavy data loads.</p>
            </div>
            <div className="p-6 rounded-2xl bg-[#182234] border border-[#222f49] hover:border-primary/50 transition-colors shadow-sm">
              <h4 className="text-primary font-bold mb-3 text-lg">Adaptive Logic</h4>
              <p className="text-sm text-slate-400 leading-relaxed">Integrated reactive state management and dynamic routing to unify previously fragmented data sources into a single source of truth.</p>
            </div>
          </div>
        </div>
      </section>
