    ...
    <>
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 py-6 border-b border-surface-border">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[#90a4cb] text-lg w-full font-normal">{project.description}</p>
        </div>
        <div className="flex gap-3 pb-2">
          {project.liveUrl && project.liveUrl !== "#" && (
            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 min-w-[120px] cursor-pointer justify-center rounded-xl h-12 px-6 bg-primary text-white text-sm font-bold shadow-xl shadow-primary/20 hover:scale-105 transition-transform">
